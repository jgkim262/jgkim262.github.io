...
<span class="xsmall">As a teaching assistant (TA) for the courses below, Jason led recitation sessions and held office hours.</span>
<div class="teaching" markdown="1">
## Financial Accounting
{: .course-title}

**Executive MBA - MIT Sloan**{: .program-title}

* Spring 2025 - TA for Professor [Nemit Shroff](https://mitsloan.mit.edu/faculty/directory/nemit-shroff){: .coauthor}

**Master of Finance - MIT Sloan**{: .program-title}
...
**Doctoral Seminar in Accounting - MIT Sloan**{: .program-title}
...
* Spring 2025 - TA for Professor [Nemit Shroff](https://mitsloan.mit.edu/faculty/directory/nemit-shroff){: .coauthor}
* Fall 2024 - TA for Professor [Rachel Hayes](https://eccles.utah.edu/team/rachel-hayes/){: .coauthor} (during her visit at MIT)
